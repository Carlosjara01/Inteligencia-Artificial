...
17# Librerías para el Agente 3

!pip install transformers -q

from transformers import pipeline

18# - Agente 3 Comunicador

class AgenteComunicador:

    def __init__(self, resultados, mejor_modelo):
        self.resultados = resultados
        self.mejor_modelo = mejor_modelo

    def generar_resumen(self):

        mejor_fila = self.resultados.iloc[0]
        ...
        Accuracy: {mejor_fila['Accuracy']:.4f}
        Precision: {mejor_fila['Precision']:.4f}
        Recall: {mejor_fila['Recall']:.4f}
        F1 Score: {mejor_fila['F1']:.4f}

        El modelo fue seleccionado por obtener el mejor rendimiento general.
        """

        return resumen

19# Ejecutar Agente 3
...
reporte_preliminar = agente3.generar_resumen()

print(reporte_preliminar)

20# Generar reporte final del Agente 3

reporte_final = agente3.generar_resumen()

print(reporte_final)

21# Guardar reporte final
